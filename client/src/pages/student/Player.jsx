    ...
    <>
      <div className="p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36">
        ...
        <div className="text-gray-100">
          <h2 className="text-white text-xl font-semibold">Course Overview</h2>
          ...
          <div className="flex items-center gap-2 py-3 mt-10">
            <h1 className="text-white text-xl font-bold">Give your rating:</h1>
        ...
        <div className="md:mt-10">
          {playerData ? (
            <div>
              ...
              <YouTube
                // 1. Add a 'key' to force the player to reload when the video changes
                key={playerData.lectureId}
                // 2. Updated ID extraction logic to handle "watch?v=" URLs
                videoId={
                  playerData.lectureUrl.includes("v=")
                    ? playerData.lectureUrl.split("v=")[1].split("&")[0]
                    : playerData.lectureUrl.split("/").pop()
                }
                // 3. Add autoplay so it plays immediately
