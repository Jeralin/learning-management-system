...
const CourseDetails = () => {
  ...
  const enrollCourse = async () => {
    try {
      if (!userData) {
        return toast.warn("Log In to Access");
      }
      if (isAlreadyEnrolled) {
        return toast.warn("You're In!");
      }
        ...
        <div className="max-w-xl z-10 text-white">
          ...
          <p className="text-sm">
            ...
            <span className="text-orange-500 underline">
              {courseData?.educator?.name || "Unknown Tutor"}
            </span>
          </p>
        ...
        <div className="max-w-md z-10 shadow-lg md:rounded-none overflow-hidden bg-black min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            ...
            <button
              ...
              className="md:mt-6 mt-4 w-full py-3 rounded bg-orange-500 font-medium"
            >
